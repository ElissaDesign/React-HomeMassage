            ...
            <div className="basis-4/5">
                ...
                <div className="p-5 shadow-md m-5 flex">
                    <div className="basis-2/5 flex items-center justify-around">
                       <img src="https://imgs.search.brave.com/fbHeL2V9gmsBMtxj1yepuS9z7g1iBK6vggNXzuM-Mv8/rs:fit:760:760:1/g:ce/aHR0cHM6Ly9pY29u/LWxpYnJhcnkuY29t/L2ltYWdlcy9uby1p/bWFnZS1pY29uL25v/LWltYWdlLWljb24t/MC5qcGc" alt="" className="w-[150px] h-[150px] object-contain rounded-full" /> 
                    </div>
                    <div className="basis-3/5">
                        <form className='flex flex-wrap gap-5'>
                            <div className='w-[40%] flex items-center'>
                                <label htmlFor='file' className='cursor-pointer'>Image Upload: <DriveFolderUploadIcon/> </label>
                                <input className='w-full' type="file" id='file' style={{display: 'none'}}/>
                            </div>
                            <div className='w-[40%]'>
