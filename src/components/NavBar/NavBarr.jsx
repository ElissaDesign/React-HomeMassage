    ...
    <Box sx={{ display: 'flex' }}>
      <AppBar component="nav">
        <Toolbar>
          ...
          >
            <Link to="/"><img src={logo} width={120} alt="home-massage-logo" className=' '/></Link>
          </Typography>
          ...
          className=" ">
            {Links.map((link) =>(
                <li className="">
                <Link  to={link.link} className='text-primary hover:text-blue duration-500'>{link.name}</Link>
                </li>
                ))}
